...
ParameterStruct(4).name='sail.tif - starting algorithm';                % Name of the investigated compression mode
ParameterStruct(4).input_image_filename='data/images/sail.tif';         % Input image file name
ParameterStruct(4).intermediate_resolution=ID_same;                         % Resolution to which the input will be converted 
ParameterStruct(4).intermediate_colorformat=ID_grayscale;                   % Color format to which the input will be converted
ParameterStruct(4).compression_type=ID_nocompression;                       % Compression mode
ParameterStruct(4).output_stream_filename='data/compressed/sail.ivc';   % Output file name (Compressed)
ParameterStruct(4).verbose=ID_verbose_on;                                   % Status is shown during compression
ParameterStruct(4).reserved1=0;                                             % Reserved1
ParameterStruct(4).reserved2=0;                                             % Reserved2
ParameterStruct(4).reconstructed_image_filename='data/reconstructed/sail.tif';    % Output file name (Reconstructed)
%--------------------------
